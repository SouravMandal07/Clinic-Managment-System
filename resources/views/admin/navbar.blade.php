<div class="container-fluid page-body-wrapper">
    ...
    <nav class="navbar p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="indexx.html"><img src="admin/assets/images/logo-mini.svg"
                    alt="logo" /></a>
        </div>
                ...
                <li class="nav-item dropdown">
                        ...
                        <div class="navbar-profile">
                            @if (Auth::user()->profile_photo_path != null)
                                <img class="img-xs rounded-circle "
                                    src="{{ asset('storage/' . Auth::user()->profile_photo_path) }}" alt="admin image">
                            @else
                                <img src="{{ asset('admin/assets/images/avatar.png') }}" alt="demo image">
                            @endif
                            {{-- <img class="img-xs rounded-circle"
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                        ...
                        <a href="{{ url('admin_logout') }}" class="dropdown-item preview-item">
                            ...
                            <div class="preview-item-content">
                                <p href="{{ url('admin_logout') }}" class="preview-subject mb-1">Log out</p>
                            </div>
                        </a>
